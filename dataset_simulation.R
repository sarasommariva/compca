...
for (isim in 1:num_sim){
  ...
  #     Z_boot = Z_transf[randi(n_z, n_z, 1), ]
  #   
  #   # 8.b 
  ...
  # }
  #   # 8.c
  # boot_mu_T[isim] = mean(boot_stat_values)
  # boot_sigma2_T[isim] = var(boot_stat_values)
  # 
  #   # 8.d
  # boot_const_chi = 0.5*boot_sigma2_T[isim] / boot_mu_T[isim]
  # boot_df_chi = round(2*boot_mu_T[isim]^2/boot_sigma2_T[isim])
  # 
  # boot_pvalues[isim] = pchisq(stat_values[isim]/boot_const_chi,
  #                            boot_df_chi, lower.tail = FALSE)
}
...
save(result, file="prova_belinona.Rdata")
